...
const ProjectHeader = ({ id, activeTab, setActiveTab }: Props) => {
  ...
  if (error) return <div>Error loading project data</div>; // Handle error state
  ...
  return (
    <div className="px-4 xl:px-6">
      ...
      <div className="pb-6 pt-6 lg:pb-4 lg:pt-8">
        {/* header */}
        <Header
          name={project ? ` ${project.id} · ${project.name}` : "Loading..."}
          description={project ? project.description : "Loading..."}
          buttonComponent={
            <button
